...
AxesPage::AxesPage(wxBookCtrlBase *parent, LinnStrument * pLinnStrument, const LSSplitType split)
	...
	// Controls
				// toggles
	chkSEND_Y = new wxCheckBox(this, SEND_Y_ID, L"&Send Y-axis timbre messages");
	...
	wxStaticText * lblCC_FOR_Y = new wxStaticText(this, wxID_ANY, L"CC for Y:");
	wscCC_FOR_Y = new wxSpinCtrl(this, CC_FOR_Y_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, pMyLinnStrument->GetCC_FOR_Y(split), "Y-axis message");
	hBoxY->Add(lblCC_FOR_Y, 0, wxEXPAND);
	hBoxY->Add(wscCC_FOR_Y, 0, wxEXPAND);

	// Values are constrained by MIN_CC and MAX_CC
	wxStaticText * lblMIN_CC_FOR_Y = new wxStaticText(this, wxID_ANY, L"Min. Y value:");
	wscMIN_CC_FOR_Y = new wxSpinCtrl(this, MIN_CC_FOR_Y_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, pMyLinnStrument->GetMIN_CC_FOR_Y(split), "Min. CC value for Y-axis");
	hBoxY->Add(lblMIN_CC_FOR_Y, 0, wxEXPAND);
	hBoxY->Add(wscMIN_CC_FOR_Y, 0, wxEXPAND);

	wxStaticText * lblMAX_CC_FOR_Y = new wxStaticText(this, wxID_ANY, L"Max. Y value:");
	wscMAX_CC_FOR_Y = new wxSpinCtrl(this, MAX_CC_FOR_Y_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, pMyLinnStrument->GetMAX_CC_FOR_Y(split), "Max. value for Y-axis");
	hBoxY->Add(lblMAX_CC_FOR_Y, 0, wxEXPAND);
	hBoxY->Add(wscMAX_CC_FOR_Y, 0, wxEXPAND);
	
	// Toggle:
	chkRELATIVE_Y = new wxCheckBox(this, RELATIVE_Y_ID, L"Relative &Y");
	...
	wxStaticText * lblEXPRESSION_FOR_Y = new wxStaticText(this, wxID_ANY, L"Expression for Y:");
	wrbEXPRESSION_FOR_Y = new wxRadioBox(this, EXPRESSION_FOR_Y_ID, L"MIDI Expression for Y", wxDefaultPosition, wxDefaultSize, WXSIZEOF(ExpressionY), ExpressionY, pMyLinnStrument->GetEXPRESSION_FOR_Y(split), wxRA_SPECIFY_ROWS);
	hBoxY->Add(lblEXPRESSION_FOR_Y, 0, wxEXPAND);
	hBoxY->Add(wrbEXPRESSION_FOR_Y, 0, wxEXPAND);
				
	wxStaticText * lblINITIAL_RELATIVE_VALUE_FOR_Y = new wxStaticText(this, wxID_ANY, L"Initial relative value for Y:");
	wscINITIAL_RELATIVE_VALUE_FOR_Y = new wxSpinCtrl(this, INITIAL_RELATIVE_VALUE_FOR_Y_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, pMyLinnStrument->GetINITIAL_RELATIVE_VALUE_FOR_Y(split), "&Initial relative value for Y-axis");
	hBoxY->Add(lblINITIAL_RELATIVE_VALUE_FOR_Y, 0, wxEXPAND);
	hBoxY->Add(wscINITIAL_RELATIVE_VALUE_FOR_Y, 0, wxEXPAND);
				
				// toggle
		chkSEND_Z = new wxCheckBox(this, SEND_Z_ID, L"&Send Z-axis loudness messages");
		...
		wxStaticText * lblCC_FOR_Z = new wxStaticText(this, wxID_ANY, L"CC for Z:");
		wscCC_FOR_Z = new wxSpinCtrl(this, CC_FOR_Z_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, pMyLinnStrument->GetCC_FOR_Z(split), "CC for Z");
		hBoxZ->Add(lblCC_FOR_Z, 0, wxEXPAND);
		hBoxZ->Add(wscCC_FOR_Z, 0, wxEXPAND);

		// Values are constrained by MIN_CC and MAX_CC
		wxStaticText * lblMIN_CC_FOR_Z = new wxStaticText(this, wxID_ANY, L"Min. Z value:");
		wscMIN_CC_FOR_Z = new wxSpinCtrl(this, MIN_CC_FOR_Z_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, pMyLinnStrument->GetMIN_CC_FOR_Z(split), "Min. CC value for Z-axis");
		hBoxZ->Add(lblMIN_CC_FOR_Z, 0, wxEXPAND);
		hBoxZ->Add(wscMIN_CC_FOR_Z, 0, wxEXPAND);
		
		wxStaticText * lblMAX_CC_FOR_Z = new wxStaticText(this, wxID_ANY, L"Max. Z value:");
		wscMAX_CC_FOR_Z = new wxSpinCtrl(this, MAX_CC_FOR_Z_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, pMyLinnStrument->GetMAX_CC_FOR_Z(split), "Min. CC value for Z-axis");
		hBoxZ->Add(lblMAX_CC_FOR_Z, 0, wxEXPAND);
		hBoxZ->Add(wscMAX_CC_FOR_Z, 0, wxEXPAND);
		
		/*
		chkRELATIVE_Z = new wxCheckBox(this, RELATIVE_Z_ID, L"&Relative &Z");
		chkRELATIVE_Z->SetValue(pMyLinnStrument->GetRELATIVE_Z(split));
		hBoxZ->Add(chkRELATIVE_Z, 0, wxEXPAND);
		*/

		// Value is an LSExpressionZ
		wxStaticText * lblEXPRESSION_FOR_Z = new wxStaticText(this, wxID_ANY, L"Expression for Z:");
		wrbEXPRESSION_FOR_Z = new wxRadioBox(this, EXPRESSION_FOR_Z_ID, L"MIDI Expression for Z", wxDefaultPosition, wxDefaultSize, WXSIZEOF(ExpressionZ), ExpressionZ, pMyLinnStrument->GetEXPRESSION_FOR_Z(split), wxRA_SPECIFY_ROWS);
		hBoxZ->Add(lblEXPRESSION_FOR_Z, 0, wxEXPAND);
		hBoxZ->Add(wrbEXPRESSION_FOR_Z, 0, wxEXPAND);
		
		wxStaticText * lbl14BIT_CC_VALUE_FOR_Z = new wxStaticText(this, wxID_ANY, L"14-bit CC value for Z:");
		wsc14BIT_CC_VALUE_FOR_Z = new wxSpinCtrl(this, CC_VALUE_FOR_Z_14BIT_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, pMyLinnStrument->Get14BIT_CC_VALUE_FOR_Z(split), "14-&bit CC value for Z");
