...
// Controls
	...
	wxStaticText * lblSWITCH1_ASSIGN = new wxStaticText(this, wxID_ANY, L"Switch&1 function:");
	wrbSWITCH1_ASSIGN = new wxRadioBox(this, SWITCH1_ASSIGN_ID, L"Switch &1 assignment", wxDefaultPosition, wxDefaultSize, WXSIZEOF(wstrSwitchAssignments), wstrSwitchAssignments, pMyLinnStrument->GetSWITCH1_ASSIGN(), wxRA_SPECIFY_ROWS);
	gSizer->Add(lblSWITCH1_ASSIGN, 0, wxEXPAND);
	gSizer->Add(wrbSWITCH1_ASSIGN, 0, wxEXPAND);

	// Toggle:
chkSWITCH1_BOTH_SPLITS = new wxCheckBox(this, SWITCH1_BOTH_SPLITS_ID, L"Switch 1 affects both splits");
	chkSWITCH1_BOTH_SPLITS->SetValue(LinnStrument::LSToggle(pMyLinnStrument->GetSWITCH1_BOTH_SPLITS()));
	gSizer->Add(chkSWITCH1_BOTH_SPLITS, 0, wxEXPAND);

	// Values are constrained by MIN_CC and MAX_CC
	// wxStaticText * lblGLOABAL_CC_FOR_CC65 = new wxStaticText(this, wxID_ANY, L"CC for CC65:");
	// WXSpinCtrl * wscGLOABAL_CC_FOR_CC65;  // Changes the CC for all switches - Legacy option, see NRPN 255 - 258
		
	wxStaticText * lblCC_FOR_SWITCH1_SUSTAIN = new wxStaticText(this, wxID_ANY, L"CC for Switch1 sustain:");
	wscCC_FOR_SWITCH1_SUSTAIN = new wxSpinCtrl(this, CC_FOR_SWITCH1_SUSTAIN_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, pMyLinnStrument->GetCC_FOR_SWITCH1_SUSTAIN(), "CC for switch  1 sustain");
	gSizer->Add(lblCC_FOR_SWITCH1_SUSTAIN, 0, wxEXPAND);
	gSizer->Add(wscCC_FOR_SWITCH1_SUSTAIN, 0, wxEXPAND);

		wxStaticText * lblCC_FOR_SWITCH1_CC65 = new wxStaticText(this, wxID_ANY, L"CC for Switch1 CC65:");
		wscCC_FOR_SWITCH1_CC65 = new wxSpinCtrl(this, CC_FOR_SWITCH1_CC65_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, pMyLinnStrument->GetCC_FOR_SWITCH1_CC65(), "CC for switch  1 CC65");
		gSizer->Add(lblCC_FOR_SWITCH1_CC65, 0, wxEXPAND);
		gSizer->Add(wscCC_FOR_SWITCH1_CC65, 0, wxEXPAND);

				// Value is an LSSwitchAssignment
		wxStaticText * lblSWITCH2_ASSIGN = new wxStaticText(this, wxID_ANY, L"Switch&2 function:");
		wrbSWITCH2_ASSIGN = new wxRadioBox(this, SWITCH2_ASSIGN_ID, L"Switch &2 assignment", wxDefaultPosition, wxDefaultSize, WXSIZEOF(wstrSwitchAssignments), wstrSwitchAssignments, pMyLinnStrument->GetSWITCH2_ASSIGN(), wxRA_SPECIFY_ROWS);
		gSizer->Add(lblSWITCH2_ASSIGN, 0, wxEXPAND);
		gSizer->Add(wrbSWITCH2_ASSIGN, 0, wxEXPAND);

			// Toggle:
chkSWITCH2_BOTH_SPLITS = new wxCheckBox(this, SWITCH2_BOTH_SPLITS_ID, L"Switch 2 affects both splits");
	chkSWITCH2_BOTH_SPLITS->SetValue(LinnStrument::LSToggle(pMyLinnStrument->GetSWITCH2_BOTH_SPLITS()));
	gSizer->Add(chkSWITCH2_BOTH_SPLITS, 0, wxEXPAND);

	// Values are constrained by MIN_CC and MAX_CC
	wxStaticText * lblCC_FOR_SWITCH2_SUSTAIN = new wxStaticText(this, wxID_ANY, L"CC for Switch2 sustain:");
	wscCC_FOR_SWITCH2_SUSTAIN = new wxSpinCtrl(this, CC_FOR_SWITCH2_SUSTAIN_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, pMyLinnStrument->GetCC_FOR_SWITCH2_SUSTAIN(), "CC for switch  2 sustain");
	gSizer->Add(lblCC_FOR_SWITCH2_SUSTAIN, 0, wxEXPAND);
	gSizer->Add(wscCC_FOR_SWITCH2_SUSTAIN, 0, wxEXPAND);

	wxStaticText * lblCC_FOR_SWITCH2_CC65 = new wxStaticText(this, wxID_ANY, L"CC for Switch2 CC65:");
	wscCC_FOR_SWITCH2_CC65 = new wxSpinCtrl(this, CC_FOR_SWITCH2_CC65_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, pMyLinnStrument->GetCC_FOR_SWITCH2_CC65(), "CC for switch  2 CC65");
	gSizer->Add(lblCC_FOR_SWITCH2_CC65, 0, wxEXPAND);
	gSizer->Add(wscCC_FOR_SWITCH2_CC65, 0, wxEXPAND);
