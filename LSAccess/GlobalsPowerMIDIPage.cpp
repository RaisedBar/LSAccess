	...
	pMyParent(parent)
{
	...
	wxStaticText * lblGLOBAL_MIDI_DEVICE_IO = new wxStaticText(myPanel, wxID_ANY, L"&Connection:");
	...
	wxStaticText * lblDEVICE_MIN_BYTE_INTERVAL_VALUE = new wxStaticText(myPanel, wxID_ANY, L"&Min. interval between bytes:");
