...
FootSwitchesPage::FootSwitchesPage(wxBookCtrlBase *parent, LinnStrument * pLinnStrument)
	...
	wxStaticText * lblFOOT_LEFT_ASSIGN = new wxStaticText(myPanel, wxID_ANY, L"&Left function:");
...
chkFOOT_LEFT_BOTH_SPLITS = new wxCheckBox(myPanel, FOOT_LEFT_BOTH_SPLITS_ID, L"Left switch affects both splits");
	...
	wxStaticText * lblCC_FOR_LEFT_FOOT_SUSTAIN = new wxStaticText(myPanel, wxID_ANY, L"Left CC for sustain:");
	...
	wxStaticText * lblCC_FOR_LEFT_FOOT_CC65 = new wxStaticText(myPanel, wxID_ANY, L"Left CC for CC65:");
	...
	// Value is an LSSwitchAssignment
	wxStaticText * lblFOOT_RIGHT_ASSIGN = new wxStaticText(myPanel, wxID_ANY, L"&Right function:");
	...
	// Values are constrained by MIN_CC and MAX_CC
	wxStaticText * lblCC_FOR_RIGHT_FOOT_SUSTAIN = new wxStaticText(myPanel, wxID_ANY, L"&Right CC for sustain:");
	...
	wxStaticText * lblCC_FOR_RIGHT_FOOT_CC65 = new wxStaticText(myPanel, wxID_ANY, L"Right CC for CC65:");
