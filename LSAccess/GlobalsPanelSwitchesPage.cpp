	...
	pMyParent(new wxBookCtrl())
{
	...
	wxRadioBox * wrbGLOBAL_SWITCH1_ASSIGN_NRPN = new wxRadioBox(myPanel, GLOBAL_SWITCH1_ASSIGN_NRPN_ID, L"Switch &1 assignment", wxDefaultPosition, wxDefaultSize, WXSIZEOF(wstrSwitchAssignments), wstrSwitchAssignments, m_Settings.GetGLOBAL_SWITCH1_ASSIGN_NRPN(), wxRA_SPECIFY_ROWS);
	// Toggle:
	wxCheckBox * chkGLOBAL_SWITCH1_BOTH_SPLITS_NRPN = new wxCheckBox(myPanel, GLOBAL_SWITCH1_BOTH_SPLITS_NRPN_ID, L"Switch 1 affects both splits");
	...
	// WXSpinCtrl * wscGLOABAL_CC_FOR_CC65;  // Changes the CC for all switches - Legacy option, see NRPN 255 - 258
		...
		wxSpinCtrl * wscGLOBAL_CC_FOR_SWITCH1_CC65 = new wxSpinCtrl(myPanel, GLOBAL_CC_FOR_SWITCH1_CC65_ID, "", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, MIN_CC, MAX_CC, m_Settings.GetGLOBAL_CC_FOR_SWITCH1_CC65(), "CC for switch  1 CC65");
			// Value is an LSSwitchAssignment
	wxRadioBox * wrbGLOBAL_SWITCH2_ASSIGN_NRPN = new wxRadioBox(myPanel, GLOBAL_SWITCH2_ASSIGN_NRPN_ID, L"Switch &2 assignment", wxDefaultPosition, wxDefaultSize, WXSIZEOF(wstrSwitchAssignments), wstrSwitchAssignments, m_Settings.GetGLOBAL_SWITCH2_ASSIGN_NRPN(), wxRA_SPECIFY_ROWS);
	// Toggle:
	wxCheckBox * chkGLOBAL_SWITCH2_BOTH_SPLITS_NRPN = new wxCheckBox(myPanel, GLOBAL_SWITCH2_BOTH_SPLITS_NRPNN_ID, L"Switch 2 affects both splits");
		// Values are constrained by MIN_CC and MAX_CC
