...
// Value is constrained by MIN_LIGHTS_PRESET and MAX_LIGHTS_PRESET 
	...
	hBox1->Add(lblGLOBAL_ACTIVE_LIGHTS_PRESET, 0, wxEXPAND);
	hBox1->Add(wscGLOBAL_ACTIVE_LIGHTS_PRESET, 0, wxEXPAND);
...
// Toggles:
	...
	gSizer->Add(chkGLOBAL_MAIN_NOTE_LIGHT_C, 0, wxEXPAND);
	...
	gSizer->Add(chkGLOBAL_MAIN_NOTE_LIGHT_C_SHARP, 0, wxEXPAND);
	...
	gSizer->Add(chkGLOBAL_MAIN_NOTE_LIGHT_D, 0, wxEXPAND);
	...
	gSizer->Add(chkGLOBAL_MAIN_NOTE_LIGHT_D_SHARP, 0, wxEXPAND);
	...
	gSizer->Add(chkGLOBAL_MAIN_NOTE_LIGHT_E, 0, wxEXPAND);
	...
	gSizer->Add(chkGLOBAL_MAIN_NOTE_LIGHT_F, 0, wxEXPAND);
	...
	gSizer->Add(chkGLOBAL_MAIN_NOTE_LIGHT_F_SHARP, 0, wxEXPAND);
	...
	gSizer->Add(chkGLOBAL_MAIN_NOTE_LIGHT_G, 0, wxEXPAND);
	...
	gSizer->Add(chkGLOBAL_MAIN_NOTE_LIGHT_G_SHARP, 0, wxEXPAND);
	...
	gSizer->Add(chkGLOBAL_MAIN_NOTE_LIGHT_A, 0, wxEXPAND);
	...
	gSizer->Add(chkGLOBAL_MAIN_NOTE_LIGHT_A_SHARP, 0, wxEXPAND);
...
gSizer->Add(chkGLOBAL_MAIN_NOTE_LIGHT_B, 0, wxEXPAND);

hBox1->Add(gSizer, 0, wxEXPAND);
