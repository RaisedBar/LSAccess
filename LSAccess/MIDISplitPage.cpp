...
chkCHANNEL_PER_NOTE_1->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_1(split));
...
chkCHANNEL_PER_NOTE_2->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_2(split));
...
chkCHANNEL_PER_NOTE_3->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_3(split));
...
chkCHANNEL_PER_NOTE_4->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_4(split));
...
chkCHANNEL_PER_NOTE_5->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_5(split));
...
chkCHANNEL_PER_NOTE_6->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_6(split));
...
chkCHANNEL_PER_NOTE_7->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_7(split));
...
chkCHANNEL_PER_NOTE_8->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_8(split));
...
chkCHANNEL_PER_NOTE_9->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_9(split));
...
chkCHANNEL_PER_NOTE_10->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_10(split));
...
chkCHANNEL_PER_NOTE_11->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_11(split));
...
chkCHANNEL_PER_NOTE_12->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_12(split));
...
chkCHANNEL_PER_NOTE_13->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_13(split));
...
chkCHANNEL_PER_NOTE_14->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_14(split));
...
chkCHANNEL_PER_NOTE_15->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_15(split));
...
chkCHANNEL_PER_NOTE_16->SetValue(pMyLinnStrument->GetCHANNEL_PER_NOTE_16(split));
...
void MIDISplitPage::OnMIDI_MAIN_CHANNEL(wxSpinEvent& event)
{
	...
	wxMessageBox( wxString::Format( "%d", pMyLinnStrument->GetMIDI_MAIN_CHANNEL(m_Split)));
}
